...
// //           .filter(row => (row.RoofSize || row.roofSize) && !isNaN(row.RoofSize || row.roofSize))
// //           .map(row => ({
// //             ...row,
// //             state: row.State || row.state,
// //             roofType: row.RoofType || row.roofType,
// //             roofSize: row.RoofSize || row.roofSize,
// //             projectDate: row.Date || row.projectDate,
...
//       <div className="chart-box">
//         <h4>Project Density (Map View)</h4>
//         <MapContainer center={[37.7749, -95.7129]} zoom={4} style={{ height: '400px', width: '100%' }}>
//           <TileLayer
//             url="https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png"
//             attribution='&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors'
//           />
